    ...
    return (
        ...
        <div className="app-container">
            ...
            <div className="tab-content">
                ...
                {activeTab === 'list' && <RecordsList records={records} onDelete={handleDeleteRecord} onEdit={handleEditRecord} onGoToRecord={() => setActiveTab('record')} />}
